...
($context["app"] ?? null), "request", [], "any", false, false, false, 35), "query", [], "any", false, false, false, 35), "get", [0 => "id_cms_category"], "method", false, false, false, 35)]), "desc" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 51, "817822633")->display(twig_array_merge($context, ["grid" => ($context["cmsCategoryGrid"] ?? null)]));
        // line 58
        echo "  ";
    }
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "/home/u1573007/public_html/src/PrestaShopBundle/Resources/views/Admin/Improve/Design/Cms/index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_19f773e9a7337752b0238505d261b218___817822633 extends Template
{
    private $source;
    private $macros = [];
